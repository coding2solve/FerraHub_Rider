...
import 'package:ferrahub/Assistants/geoFireAssistant.dart';
import 'package:ferrahub/DataHandler/appData.dart';
import 'package:ferrahub/Models/directDetails.dart';
import 'package:ferrahub/Models/nearbyAvailableDrivers.dart';
                  ...
                  child: Row(
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text("Babatunde", style: TextStyle(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  ((tripDirectionDetails != null)
                                      ? '\ZAR ${AssistantMethods.calculateFares(
                                      (tripDirectionDetails)) }.00'
                                      : ''), style: TextStyle(
                                  fontSize: 17.0, fontFamily: "Brand-Bold",),
                                ),
                              ],
                            ),
                          ),
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment
                                    .spaceBetween,
                                children: [
                                  Text("Request Ride", style: TextStyle(
                                      fontSize: 18.0,
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Icon(
                            Icons.close, size: 26.0, color: Colors.grey[250]),
                      ),
                    ),
                    SizedBox(height: 10.0,),
