...
import 'package:ferrahub/Models/placePredictions.dart';
...
class PredictionTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> getPlaceAddressDetails(String placeId, context)
    async
    {
      showDialog(
        context: context ,
       ...
       if(res["status"] == "OK")
         {
           ...
           Provider.of<AppData>(context, listen: false). updatedDropOffLocationAddress(address);
